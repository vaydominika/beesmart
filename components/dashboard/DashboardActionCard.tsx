...
export function DashboardActionCard({ title, description, actionLabel, onAction, targetId }: DashboardActionCardProps) {
  const handleAction = () => {
  ...
  return (
    <section className="relative min-w-0 overflow-hidden rounded-2xl border border-[var(--dashboard-line)] bg-[var(--dashboard-surface)] p-5">
      ...
      <div className="relative z-10 min-w-0">
        ...
        <WorkspaceButton type="button" variant="ghost" size="compact" className="mt-3 -ml-3" onClick={handleAction}>
